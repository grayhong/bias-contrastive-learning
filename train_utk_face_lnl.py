...
from debias.networks.resnet_lnl import LNLBiasPredictor, LNLResNet18
...
def main():
    ...
    exp_name = f'lnl-utk_face_{opt.task}-{opt.exp_name}-lr{opt.lr}-bs{opt.bs}-seed{opt.seed}'
